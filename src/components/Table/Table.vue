                ...
                <template slot-scope="scope" >
                  ...
                  <span v-if="item.type==='button'" >
                    ...
                    <el-dropdown v-if="item.type==='dropdown'">
                      <el-button type="primary" :size="size || item.size">
                          {{item.label}}<i class="el-icon-arrow-down el-icon--right"></i>
                      </el-button>
                        <el-dropdown-menu :size="size || item.size" slot="dropdown">
                            <el-dropdown-item v-for="m in item.menu" @click.native="m.handle(that, scope.row)">{{m.label}}</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                  <!-- 输入框 -->
